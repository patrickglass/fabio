...
func TestPassingServices(t *testing.T) {
	var (
		...
		serfNode2Pass = &api.HealthCheck{Node: "node2", CheckID: "serfHealth", Status: "passing"}
		serfNode2Fail = &api.HealthCheck{Node: "node2", CheckID: "serfHealth", Status: "critical"}
		...
		svc1Node2Fail = &api.HealthCheck{Node: "node2", CheckID: "service:abc", Status: "critical", ServiceName: "abc", ServiceID: "abc-1"}
	...
	tests := []struct {
		...
		{[]string{"passing"}, []*api.HealthCheck{serfPass, serfNode2Pass, svc1Pass, svc1Node2Pass}, []*api.HealthCheck{svc1Pass, svc1Node2Pass}},
		{[]string{"passing"}, []*api.HealthCheck{serfPass, serfNode2Pass, svc1Pass, svc1Node2Fail}, []*api.HealthCheck{svc1Pass}},
		{[]string{"passing"}, []*api.HealthCheck{serfPass, serfNode2Fail, svc1Pass, svc1Node2Pass}, []*api.HealthCheck{svc1Pass}},
		{[]string{"passing"}, []*api.HealthCheck{serfFail, serfNode2Pass, svc1Pass, svc1Node2Pass}, []*api.HealthCheck{svc2Pass}},
